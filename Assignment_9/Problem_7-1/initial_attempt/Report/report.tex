...
This experiment studies \textbf{tabular reinforcement learning} in a small stochastic warehouse navigation problem. The environment is a $4 \times 4$ grid world in which an agent started at the lower-left corner and must learn how to reach a goal state at $(3, 3)$ while avoiding a hazardous state at $(3, 2)$. The task was intentionally simple enough that the full state space can be represented exactly with a tabular value function, yet rich enough to highlight important reinforcement-learning ideas such as stochastic transitions, exploration, bootstrapping, and the difference between \textbf{off-policy} and \textbf{on-policy} learning.
